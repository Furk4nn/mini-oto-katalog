...
import '../models/auto_product_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _categories = AutoProductService.getCategories();
    _loadProducts();
  }

  void _loadProducts() {
    setState(() {
      List<Product> products = AutoProductService.getByCategory(_selectedCategory);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mini Oto Katalog'),
        actions: [
          Stack(
            children: [
              IconButton(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${_displayedProducts.length} adet ürün bulundu.',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 13,
                    ),
